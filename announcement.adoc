...
Grooscript is a library that converts groovy or java code to javascript. You can explore main site for more
...
with groovy is very fun, and it improves your skills in both worlds. Working with DSL's, traits, AST's,
