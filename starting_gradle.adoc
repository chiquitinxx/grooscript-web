...
Create a +build.gradle+ file with the grooscript plugin data and gradle 2.0 wrapper.
...
in your browser, the javascript converted code is. For *convert* your groovy code to javascript,
...
dependencies {
    compile 'org.grooscript:grooscript:0.5.1'
}
--
